...
<%
  List<CommonEntity> allotList  = (List<CommonEntity>)request.getAttribute("page.mn05.reAllotList");
	int allotListSize = 0;
	if (allotList != null ) {
...
<html>
  <head>
    ...
    <script language="javascript" src="../js/calendar.js"></script>	
      ...
      function goSearch() {
				...
				form.action = "IR050310.etax";
        form.target = "_self";
				form.cmd.value = "bankReAllotList";
      	eSubmit(form);
      }
      ...
      function PowerChk(flag) {
        ...
        if (confirm("선택 건(들)을 재배정처리하겠습니까?")) {
				  form.trans_gubun.value = "133";
				  form.action = "IR050310.etax";
				  form.cmd.value = "bankReAllotReg";
				  form.target = "_self";
				  eSubmit(form);
        }
			}
      ...
      function goDelete(){
        ...
        var cnt = 0;
				...
				if (listSize == 1) {
					if (!form.allotChk.checked)	{
					  alert("재배정취소처리할 건을 체크하세요.");
					  return;
				  } else {
						form.allot_yn.value = "Y";
						if (form.allot_state.value != "S4")	{
							alert("재배정처리 건만 재배정취소처리가 가능합니다.");
							return;
						}
					}
				} else if (listSize > 1) {
        ...
        if (confirm("선택 건(들)을 재배정취소처리하겠습니까?")) {
				  form.trans_gubun.value = "133";
				  form.action = "IR050310.etax";
				  form.cmd.value = "reBaeDelete";
				  form.target = "_self";
				  eSubmit(form);
        }
			}
        ...
        var cnt = 0;
				...
				form.trans_gubun.value = "135";
				form.action = "IR050310.etax";
				form.cmd.value = "bankReAllotPms";
				form.target = "_self";
				eSubmit(form);
			}
      ...
      function goPermission2(){
        ...
        if (confirm("선택 건(들)을 책임자승인처리하겠습니까?")) {
				  form.trans_gubun.value = "135";
				  form.action = "IR050311.etax";
				  form.cmd.value = "bankReAllotTrs";
				  form.target = "hidFrame";
				  eSubmit(form);
        }
			}
      ...
      function goCancel() {
				var form = document.sForm;
				form.action = "IR050310.etax";
				form.cmd.value = "bankReAllotRtn";
        form.allot_type.value = "2";
				form.target = "_self";
				eSubmit(form);
			}
  ...
  <form name="sForm" method="post" action="IR050310.etax">
	<input type="hidden" name="cmd" value="bankReAllotList">
  ...
  <input type="hidden" name="v_flag" value="">
    <table width="993" border="0" cellspacing="0" cellpadding="0">
      <tr> 
        <td width="18">&nbsp;</td>
        <td width="975" height="40"><img src="../img/title5_2_re.gif"></td>
      </tr>
			<tr> 
        <td width="18">&nbsp;</td>
      ...
      <tr> 
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="list">
            <tr> 
              ...
              <th rowspan="2" width="10%">예산현액</th>
							...
							<th rowspan="2" width="10%">자금재배정<br>요구액</th>
							<th rowspan="2" width="8%">처리상태</th>
							<th rowspan="2" width="8%">재배정결과</th>
            </tr>
						<tr> 
              <th width="10%">기배정액</th>
            ...
            <tr>
              ...
              <td class="center">&nbsp;<%=rowData.getString("M100_ALLOTSTATE_NM")%></td>
							...
							<input type="hidden" name="part_code" value="<%=rowData.getString("M100_PARTCODE")%>">
        ...
        <td width="975"> 
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="btn">
            <tr> 
              <td>
							<img src="../img/btn_recoll.gif" alt="재배정처리" style="cursor:hand" onClick="goExcute()" align="absmiddle">&nbsp;
               <img src="../img/btn_jaebae_cancel.gif" alt="재배정취소" style="cursor:hand" onClick="goDelete()" align="absmiddle">&nbsp;
