...
<%
  ...
  String eight_business_date  = (String)request.getAttribute("page.mn01.eight_business_date");    // 8영업일 받아오기
  ...
  String semok_name = "";
	...
	if(saveFile.equals("1")){
        ...
        response.setHeader("Content-Disposition", "inline; filename=세목별 일계표_" +new java.sql.Date(System.currentTimeMillis()) + ".xls");   
								...
								<table width="964" border="0" cellspacing="0" cellpadding="0" align="center">
								    ...
								    <td>
								      ...
								      <img src="../img/board_icon1.gif" width="8" height="8" align="absmiddle"> 
											...
											<span style="width:30px"></span>
									    <img src="../img/board_icon1.gif" width="8" height="8" align="absmiddle"> 									
                      회계일자&nbsp; <input type="text" name="fis_date"  value="<%=fis_date%>" class="box3" size="8" userType="date">
        ...
        <td width="978">
          ...
          <div id="pDiv">
					...
					<table width="964" border="0" cellspacing="0" cellpadding="0">
					  ...
					  <tr>
						  <td align="center"><b><font size="3"><%=part_name%> 세목별 일계표 
              <% if (semokDailyList.size() > 0 && semokDailyList != null) { %>
              ...
              <%}%>
						...
						<tr>
						  <td align="right"><b><font size="2">수납일  
              <% if (semokDailyList.size() > 0 && semokDailyList != null) { %>
