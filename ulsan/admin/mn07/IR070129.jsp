...
<%
  ...
  String cpage = request.getParameter("cpage");	// 현재 페이지 번호 받기
    ...
    if(saveFile.equals("1")){
        ...
        response.setHeader("Content-Disposition", "inline; filename=세입월계표(회계별)_" +new java.sql.Date(System.currentTimeMillis()) + ".xls");   
...
<form name="sForm" method="post" action="IR070129.etax">
<input type="hidden" name="cmd" value="dayReport19">      
