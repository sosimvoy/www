...
<%
  ...
  String cpage = request.getParameter("cpage");	// 현재 페이지 번호 받기
    ...
    if(saveFile.equals("1")){
        ...
        response.setHeader("Content-Disposition", "inline; filename=세출월계표(회계별)_" +new java.sql.Date(System.currentTimeMillis()) + ".xls");   
...
-->
    ...
    :root p {font-size:20pt; padding-left:330px;} /*:root 지원되는 다른 모든 브라우저 */       
		 html p {font-size:20pt; padding-left:330px;} /*IE8 적용 */   
 * + html p {font-size:20pt; padding-left:330px;} /*IE7 적용 */   
 *   html p {font-size:20pt; padding-left:330px;} /*IE6 적용 */ 
...
<form name="sForm" method="post" action="IR070131.etax">
<input type="hidden" name="cmd" value="dayReport21">      
    ...
    <td>
        ...
        <tr height="50">
          <td width="120" class="re01">
            <div align="center">지 출 액</div>
          </td>
          <td width="120" class="re01">
            <div align="center">반 납 액</div>
          </td>
          <td width="120" class="re01">
        ...
        <tr height="50">
          <td class="re01"> 
            <div align="center"><%=StringUtil.formatNumber(rowData.getString("M360_ACCNAME"))%></div>      
          </td>
          <td class="re02"> 
            <div align="right"><%=StringUtil.formatNumber(rowData.getString("AMTSECHULJEONILTOT"))%></div>
          </td>
          <td class="re02"> 
            <div align="right"><%=StringUtil.formatNumber(rowData.getString("AMTSECHUL"))%></div>
          </td>
          <td class="re02"> 
            <div align="right"><%=StringUtil.formatNumber(rowData.getString("AMTSECHULBANNAP"))%></div>
          </td>
          <td class="re02"> 
            <div align="right"><%=StringUtil.formatNumber(rowData.getString("AMTSECHULJEONGJEONG"))%></div>
          </td>
          <td class="re02"> 
