...
<%
  ...
  List<CommonEntity> nongHyupList  = (List<CommonEntity>)request.getAttribute("page.mn07.nongHyupList"); 
                                                                                          //광역시세세입일계표&&차량등록사업소

	List<CommonEntity> nongHyupGwaList  = (List<CommonEntity>)request.getAttribute("page.mn07.nongHyupGwaList");  
                                                                                          //과오납환부일계표
...
<html>
      ...
      function init() {
        ...
        if(form.upfile.value.substring(idx1+1, idx2) != "xls"){
          ...
          return;
				...
				if (confirm("첨부한 엑셀파일과 자료구분과 일치합니까?")) {
					form.action = "IR071211.etax?cmd=nongHyupTmpUp&uploadDir=excel&flag=Y";
          eSubmit(form);
				}
      } 
        ...
        if(form.upfile.value.substring(idx1+1, idx2) != "xls"){
          ...
          return;
				...
				form.flag.value = "N";
				if (confirm("첨부한 엑셀파일과 자료구분과 일치합니까?")) {
					form.action = "IR071211.etax?cmd=nongHyupReg&uploadDir=excel&flag=N";
          eSubmit(form);
				}        
      }          
  ...
  <body topmargin="0" leftmargin="0">
	<form name="dForm" method="post" action="IR071211.etax">
  ...
  <form name="sForm" method="post" enctype="multipart/form-data"  action="IR071211.etax">
      ...
      <tr> 
        ...
        <td width="930"> 
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="list">
			...
			<%} else if ("G7".equals(data_type) || "G8".equals(data_type)) { %>
			<tr>
