...
try {
    ...
    // PDF 파일 생성경로 설정
//    PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("/home1/tmax_t/jeus6/webhome/app_home/cityman/upload/report/" + fileName));
   ...
   //writer.addJavaScript("this.print(false);", false);    // auto print 
    ...
    float[] widths = { 1f, 2f, 1.5f , 1.5f, 1.5f , 1.5f, 1.5f };    // 컬럼 사이즈
    t.setWidths(widths);
...
//out.println("<br>---------------<br>");
//out.println("::::iTextEnd::::");
%>
<html>
<head>
<script language="javascript">

//location.href = "../common/file_download.etax?dir=upload/report&fileName=<%=fileName%>";
