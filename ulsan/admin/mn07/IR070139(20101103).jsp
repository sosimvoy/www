...
%>
		var listCount = document.all.listCount.value;
		
		for(var i=0; i<=listCount; i++){
			
			if (i%47 == 0) {
				cellMergeChk(document.getElementById("dataList_"+i), 1, 0);
			}		
	  }
<%		
	}
...
%>
	...
	<tr>
		...
		<td colspan="3"><div align="right"><%=request.getParameter("acc_name")%></div></td>
	</tr>
</table>
<%
		for (i=0; i < reportList.size(); i++) {
			...
			if (i == 0){
%>
<table id="dataList_<%=i%>" width="713" border="1" cellspacing="0" cellpadding="2" style='border-collapse:collapse; 'bordercolor='#000000' class="basic">
	<tr height="20">
