...
* 프로그램작성자	: (주)미르이즈 
* 프로그램작성일	: 2010-09-09
* 프로그램내용		: 일계/보고서 > 보고서조회 > 세입분기표(본청 광역시세)
*************************************************************************/
%>
...
<%
  ...
  String quarter =  (String)request.getAttribute("page.mn07.quarter");
    ...
    if(saveFile.equals("1")){
        ...
        response.setHeader("Content-Disposition", "inline; filename=세입분기표(본청 광역시세)_" +new java.sql.Date(System.currentTimeMillis()) + ".xls");   
...
<form name="sForm" method="post" action="IR070134.etax">
<input type="hidden" name="cmd" value="dayReport24">
