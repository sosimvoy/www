...
* 프로그램작성자	: (주)미르이즈 
* 프로그램작성일	: 2010-09-09
* 프로그램내용		: 일계/보고서 > 보고서조회 > 세입분기표(총괄 광역시세)
*************************************************************************/
%>
...
<%
  ...
  String quarter =  (String)request.getAttribute("page.mn07.quarter");
    ...
    if(saveFile.equals("1")){
        ...
        response.setHeader("Content-Disposition", "inline; filename=세입분기표(총괄 광역시세)_" +new java.sql.Date(System.currentTimeMillis()) + ".xls");   
...
<form name="sForm" method="post" action="IR070132.etax">
<input type="hidden" name="cmd" value="dayReport22">
...
<table width="980" border="0" cellspacing="0" cellpadding="1">
  <tr>
    <td colspan="3">
      <table width="980" border="0" cellspacing="0" cellpadding="1">
        <tr height="100"> 
          <td colspan="2" style="font-size:14pt; padding-left:150px;"> 
              <b><u>세 입 분 기 표 (총괄 광역시세)</u></b>
          </td>
          <td colspan="2" width="100" align="right" valign="top" rowspan="2"> 
            <%
  ...
  <tr>
    <td>
		  ...
		  <%=TextHandler.formatDate(TextHandler.replace(request.getParameter("acc_year"),"-",""),"yyyyMMdd","yyyy")%>년  <%=quarter%>/4분기</div>
		</td>
    <td></td>
    <td></td>
  </tr>
  ...
  <tr> 
    <td>
        ...
        <tr height="20"> 
          <td colspan="2" width="110" class="re02">
            <div align="center">세&nbsp;&nbsp;&nbsp;&nbsp;목</div>
          </td>
		      <td width="100" class="re02">
            <div align="center">전분기계</div>
          </td>
	        <td width="100" class="re02">
            <div align="center">금분기계</div>
          </td >
		      <td width="100" class="re02">
          ...
          for (int i=0; i < reportList.size(); i++) {
            CommonEntity rowData = (CommonEntity)reportList.get(i);
              ...
              if(rowData.getString("M370_SEMOKNAME").equals("")){
                ...
                gubun = "지<br><br><br><br><br>방<br><br><br><br><br>세";       
                border_right = "";    
                border_left  = "";
              }
        %>
		    <tr height="20"> 
      	  <td width="10" style="<%=border_right%>" class="re01">
            <div align="center"><%=gubun%></div>
          </td>
		      <td width="90" style="<%=border_left%>" class="re01">
  ...
  <tr>
    <td>
      <table width="550" border="0" cellspacing="0" cellpadding="4" class="basic">
        ...
        <tr height="77">
          <td>
            <div align="left" style="font-size:12pt;">울산광역시 징수관 귀하</div>
          </td>
          <td> 
            <div align="right" style="font-size:12pt;">울산광역시금고</div>
          </td>
    ...
    <td>
	    <table width="400" border="0" cellspacing="2" cellpadding="1" class="basic">
          ...
          <td> 
		    ...
		    <tr height="77">  
          <td> 
            <div align="right" style="font-size:12pt;">울산광역시 징수관</div>
          </td>
        </tr>
      </table>
    </td>
