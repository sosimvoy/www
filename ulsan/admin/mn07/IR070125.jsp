...
* 프로그램작성자	: (주)미르이즈 
* 프로그램작성일	: 2010-09-09
* 프로그램내용		: 일계/보고서 > 보고서조회 > 세입월계표(총괄 광역시세)
*************************************************************************/
%>
...
<%
  CommonEntity endState = (CommonEntity)request.getAttribute("page.mn07.endState");
    ...
    if(saveFile.equals("1")){
        ...
        response.setHeader("Content-Disposition", "inline; filename=세입월계표(총괄 광역시세)_" +new java.sql.Date(System.currentTimeMillis()) + ".xls");   
...
<form name="sForm" method="post" action="IR070125.etax">
<input type="hidden" name="cmd" value="dayReport15">
    ...
    <td>
	    <table width="400" border="0" cellspacing="2" cellpadding="1" class="basic">
          ...
          <td> 
		    ...
		    <tr height="77"> 
          <td> 
            <div align="right" style="font-size:12pt;">울산광역시 징수관</font></div>
          </td>
        </tr>
      </table>
    </td>
