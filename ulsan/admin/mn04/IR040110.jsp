...
<%
  List<CommonEntity> ipgumTransList  = (List<CommonEntity>)request.getAttribute("page.mn04.ipgumTransList");

	//List<CommonEntity> acctList  = (List<CommonEntity>)request.getAttribute("page.mn04.acctList");

	CommonEntity rstData = (CommonEntity)request.getAttribute("page.mn04.rstData");

	String errMsg  = (String)request.getAttribute("page.mn04.ErrMsg");
  if (errMsg == null) {
		errMsg = "";
	}


	int ipgumTransListSize = 0;
	if (ipgumTransList != null ) {
		ipgumTransListSize = ipgumTransList.size();
	}
  ...
  <head>
    ...
    <script language="javascript" src="../js/calendar.js"></script>	
      ...
      function goSearch() {
		...
		form.flag.value = "Y";
		form.action = "IR040110.etax";
		form.cmd.value = "ipgumTransList";
      	eSubmit(form);
      }
    <% if (rstData != null) { %>
	function goContinue() {
    ...
    <%} %>
			...
			function changeAcctNo(fis_year) {
				var form = document.sForm;
				form.flag.value = "N";
				document.hidFrame.location = "IR040111.etax?cmd=ipgumTransList&fis_year="+fis_year+"&flag=N";
			}

    </script>
  </head>
  <body topmargin="0" leftmargin="0">
  <form name="sForm" method="post" action="IR040110.etax">
	<input type="hidden" name="cmd" value="ipgumTransList">
    ...
    <table width="993" border="0" cellspacing="0" cellpadding="0">
      <tr> 
        <td width="18">&nbsp;</td>
        <td width="975" height="40"><img src="../img/title4_1.gif"></td>
      </tr>
			<tr> 
        <td width="18">&nbsp;</td>
                ...
                <table width="964" border="0" cellspacing="0" cellpadding="0" align="center">
                  <tr> 
                    <td width="860"><span style="width:50"></span>
									    ...
									    계좌번호
										  <input type="text" name="acct_no" class="box3" value="<%=request.getParameter("acct_no")%>" size="14"  userType="number">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="list">
            <tr> 
              ...
              <th width="15%">거래구분</th>
						...
						<% if (ipgumTransListSize > 0 && ipgumTransList != null) {
								 String trans_gubun = "";
							   for (int i=0; i < ipgumTransListSize; i++) {
									 CommonEntity rowData = (CommonEntity)ipgumTransList.get(i);
