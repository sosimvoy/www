...
<body  topmargin="0" >
<div id="Layer1" style="position:absolute; left:2px; top:0px; width:268px; height:50px; z-index:2; visibility: hidden"> 
    ...
    <tr> 
      <td width="246" height="197" valign="top" bgcolor="#FFFFFF">
        <table width="245" border="0" cellspacing="1" cellpadding="5" bgcolor="#D7D7D7">
          <tr bgcolor="#0099CC"> 
            <td height="35"> 
              <div align="center"><b><font color="#FFFFFF">세출</font></b></div>
            </td>
          </tr>
					 <tr bgcolor="#FFFFFF"> 
            <td>
						<img src="../img/arr.gif" width="12" height="13" align="absmiddle"><a href="/admin/mn02/IR020110.etax?cmd=sugibunList">수기분등록</a></td>
          </tr>
					 <tr bgcolor="#FFFFFF"> 
            <td><img src="../img/arr.gif" width="12" height="13" align="absmiddle"><a href="/admin/mn02/IR020310.etax?cmd=bday">수기분일괄등록</a></td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
            <td><img src="../img/arr.gif" width="12" height="13" align="absmiddle"><a href="/admin/mn02/IR020210.etax?cmd=revWriteList">등록내역 조회/수정/삭제</a></td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
            <td><img src="../img/arr.gif" width="12" height="13" align="absmiddle"><a href="/admin/mn02/IR020410.etax">일괄등록미처리분</a></td>
          </tr>
          <tr bgcolor="#FFFFFF"> 
            <td height="480">&nbsp;</td>
          </tr>
