...
<%
    // 부서코드 (시군구에 속한)
    List<CommonEntity> acctCdList = (List<CommonEntity>)request.getAttribute("page.common.acctCdList");
%>
...
<script>
    ...
    <%
    for( int i=0 ; acctCdList != null && i < acctCdList.size() ; i++ ) {
        CommonEntity acctCdInfo = (CommonEntity)acctCdList.get(i);
    %>
