...
* 프로그램작성자   : (주)미르이즈
* 프로그램작성일   : 2010-07-28
* 프로그램내용	   : 세입세출외현금> 주행세 조회/수정/삭제 > 특별징수수납부
****************************************************************/
%>
...
<table width="713" border="0" cellspacing="0" cellpadding="1">
  <tr> 
    <td height="30"> 
     <div align="center"><b><font size="5"><%=TextHandler.formatDate(request.getParameter("start_date"),"yyyyMMdd","MM");%>월 주행세(발생이자) 특별징수 수납부</font></b></div>
    </td>    
  </tr>
</table>
...
<table width="713" border="1" cellspacing="0" cellpadding="0" style='border-collapse:collapse; 'bordercolor='#000000' class="basic">
  <tr style="font-weight:bold"> 
    ...
    <td height="2" align="right"> 
      <%=TextHandler.formatNumber(iwalData.getString("LAST_MONTH_AMT"))%>&nbsp;
    </td>
    <td height="2" align="center"> 
      &nbsp;
    </td>
	...
	<%
	  max_jan = iwalData.getLong("LAST_MONTH_AMT");
    }
  ...
  <tr> 
    <td height="2" align="center"> 
      <%=TextHandler.formatDate(data.getString("M060_DATE"),"yyyyMMdd","yyyy.MM.dd")%>
    </td>
...
<table width="713" border="1" cellspacing="0" cellpadding="0" style='border-collapse:collapse; 'bordercolor='#000000' class="basic">
  ...
  <tr> 
    ...
    <td height="2" align="right"> 
      <%=TextHandler.formatNumber(iwalData.getString("LAST_MONTH_IJA"))%>&nbsp;
    </td>
    <td height="2" align="right"> 
  ...
  <%
	  max_ija = iwalData.getLong("LAST_MONTH_IJA");
  }
...
<table width="713" border="1" cellspacing="0" cellpadding="0" style='border-collapse:collapse; 'bordercolor='#000000' class="basic">
  <tr style="font-weight:bold"> 
    <td height="2" align="center" width="11%"> 
      구 분
    </td>
    <td height="2" align="center" width="32%"> 
      &nbsp;
    </td>
    <td height="2" align="center" width="19%"> 
      수입액 
    </td>
    <td height="2" align="center" width="19%"> 
      지급액 
