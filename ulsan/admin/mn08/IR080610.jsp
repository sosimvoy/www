...
<%
	List<CommonEntity>partCodeList =    (List<CommonEntity>)request.getAttribute("page.mn08.partCodeList");
	List<CommonEntity>allotPartCodeList =    (List<CommonEntity>)request.getAttribute("page.mn08.allotPartCodeList");
...
<html>
  ...
  <body topmargin="0" leftmargin="0" oncontextmenu="return false">
		<form name="sForm" method="post" action="IR080610.etax">
