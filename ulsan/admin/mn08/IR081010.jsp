...
<%
	List<CommonEntity>holList =    (List<CommonEntity>)request.getAttribute("page.mn08.holList");
...
<html>
		  ...
		  function goCancel(){
			 ...
			 function goUpdate(){
				...
				if (listSize == 1) {
					...
					window.open('IR081011.etax', 'popView' ,'height=300,width=300,top=100,left=100,scrollbars=no');
					form.action = "IR081011.etax";
			 ...
			 function goSave(){
				var form = document.sForm;
					...
					window.open('IR081012.etax', 'popView' ,'height=300,width=300,top=100,left=100,scrollbars=no');
  ...
  <body topmargin="0" leftmargin="0"  oncontextmenu="return false">
		<form name="sForm" method="post" action="IR081010.etax">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="list">
            ...
            <tr>                 
              <td class="fstleft"><input type="checkbox" name="userChk" value="<%=i%>"></td>
							<td>&nbsp;<%=data.getString("M290_DATE")%></td>
