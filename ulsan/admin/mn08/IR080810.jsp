...
<%
	List<CommonEntity>semokCodeList =    (List<CommonEntity>)request.getAttribute("page.mn08.semokCodeList");
    ...
    <script language="javascript" src="../js/calendar.js"></script>	
      ...
      function goSearch() {
        ...
        var form = document.sForm;
				...
				form.semokName.value=form.semokName.value.replace(/\s/g,"");
		  ...
		  function goCancel(){
			...
			function changeType(type) {
				document.location = "IR080810.etax?cmd=semokCodeList&accGubun="+type;
			}

			function changeType1(type) {
				document.location = "IR080810.etax?cmd=semokCodeList&accGubun1="+type;
			}
    </script>
  </head>
  <body topmargin="0" leftmargin="0" oncontextmenu="return false">
		<form name="sForm" method="post" action="IR080810.etax">
              ...
              <td> 
                <table width="964" border="0" cellspacing="0" cellpadding="0" align="center">
					  ...
					  <tr>
							 <td width="900" style="padding-left:30px;">
								 <table width="800" border="0" cellspacing="0" cellpadding="0" class="list">
									<tr> 
										<th width="100">장관항목</th>
										<th width="300" colspan="2">세목코드</th>
										<th width="200">세목명</th>
										<th width="200">국세/지방세구분</th>
									</tr>
									<tr>                 
										<td>&nbsp;장</td>
										<td colspan="2">
										 <select name="" iValue="<%=request.getParameter("")%>" style="width:30%">
												<option value=""></option>
											</select>	
										<span style="width:30px"></span>
										<input type="text" maxlength="7" name="semokCode" class="box3" size="20" value="<%=request.getParameter("semokCode")%>">
										</td>
										<td><input type="text" maxlength="30" name="semokName" class="box3" size="20" value="<%=request.getParameter("semokName")%>"></td>
										<td>
                      <select name="segumGubun" iValue="<%=request.getParameter("segumGubun")%>">
												<option value="1">지방세</option>
												<option value="2">국세</option>
											</select>
										</td>
									</tr>
									<tr>                 
										...
										<td><input type="text" maxlength="30" name="semokName1" class="box3" size="20" value=""></td>
										<td>
                      <select name="segumGubun" iValue="<%=request.getParameter("segumGubun")%>">
												<option value="1">지방세</option>
												<option value="2">국세</option>
									...
									<tr>                 
										...
										<td><input type="text" maxlength="30" name="semokName2" class="box3" size="20" value=""></td>
										<td>
                      <select name="segumGubun" iValue="<%=request.getParameter("segumGubun")%>">
												<option value="1">지방세</option>
												<option value="2">국세</option>
                    ...
                    <span style="width:145px"></span>
										...
										<td><input type="text" maxlength="30" name="semokName3" class="box3" size="20" value=""></td>
										<td>
                      <select name="segumGubun" iValue="<%=request.getParameter("segumGubun")%>">
												<option value="1">지방세</option>
												<option value="2">국세</option>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="list">
            ...
            <tr>                 
              <td class="fstleft"><input type="checkbox" name="userChk" value="<%=i%>"></td>
						  ...
						  <td>&nbsp;<%=data.getString("M370_ACCGUBUN")%></td>
							<td>&nbsp;<%=data.getString("M360_ACCNAME")%></td>
							<td>&nbsp;<%=data.getString("M370_WORKGUBUN")%></td>
