...
String first_business_bungi_date = (String)request.getAttribute("page.mn07.first_business_bungi_date");
String last_business_bungi_date = (String)request.getAttribute("page.mn07.last_business_bungi_date");
...
reportname = "/Dform/admin/Q306.ozr";
odinames = "Q306";
...
<html>
    <body>
        ...
        <object id="ozviewer" width="100%" height="100%" CLASSID="CLSID:0DEF32F8-170F-46f8-B1FF-4BF7443F5F25">
			...
			<param name="odi.<%=odinames%>.pcount" value="8">
			...
			<param name="odi.<%=odinames%>.args6" value="FIRST_DATE=<%=first_business_bungi_date%>">
			<param name="odi.<%=odinames%>.args7" value="LAST_DATE=<%=last_business_bungi_date%>">
			<param name="odi.<%=odinames%>.args8" value="QUARTER=<%=quarter%>">
