  ...
  <head>
    ...
    <script language="javascript" src="../js/calendar.js"></script>	
      ...
      function goSearch() {
        ...
        if (confirm("선택 건(들)을 일계등록 취소처리하겠습니까?")) {
      ...
      <tr> 
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="list">
            <tr> 
              ...
              <th width="4%">회계<br>연도</th>
							...
							<th width="11%">계좌번호</th>
							<th width="4%">좌수<br>번호</th>
							<th width="8%">신규일</th>
							<th width="8%">만기일</th>
							<th width="5%">예탁<br>기간</th>
							<th width="4%">이율(%)</th>
							<th width="11%">원금인출/<br>해지금액</th>				
              <th width="6%">처리<br>결과</th>	
              <th width="8%">해지/<br>인출일자</th>	
        ...
        <td width="975"> 
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="btn">
            <tr> 
              <td><img src="../img/btn_cancel.gif" alt="취소" style="cursor:hand" onClick="goConfirm()" align="absmiddle"></td>
            </tr>
          </table>
        </td>
      </tr>
