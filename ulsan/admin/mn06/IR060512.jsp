...
<%
  List<CommonEntity> bankDepDetailList = (List<CommonEntity>)request.getAttribute("page.mn06.bankDepDetailList");
%>
<html>
<head>
            ...
            <table width="690" border="0" cellspacing="0" cellpadding="1" align="center">
              <tr> 
                <td height="60" style="font-size:17pt"> 
                  <div align="center"><b><%=TextHandler.formatDate(request.getParameter("reg_date"), "yyyyMMdd", "yyyy")%> 일반회계 자금 예탁 내역</b></div>
                </td>
              </tr>
            </table>
            <p>&nbsp;</p>
              ...
              <tr height="35"> 
                ...
                <td width="12%"> 
                  ...
                  <div align="center">이율(%)</div>
							...
							<% String due_date = "";
	               for (int i=0; i<bankDepDetailList.size(); i++) { 
	                 CommonEntity rowData = bankDepDetailList.get(i);
