...
<%
  List<CommonEntity> inchulReportView  = (List<CommonEntity>)request.getAttribute("page.mn06.inchulReportView");
  ...
  CommonEntity manager  = (CommonEntity)request.getAttribute("page.mn06.manager");
	...
	int inchulReportViewSize = 0;
	if (inchulReportView != null ) {
		inchulReportViewSize = inchulReportView.size();
	}
%>
...
<script language="javascript">
  function goList() {
		...
		window.open('IR061212.etax', 'baePop', 'height=600,width=760,top=10,left=200,scrollbars=yes');
		form.cmd.value="inchulReportDetail";
		form.action = "IR061212.etax";
		form.target = "baePop";
		eSubmit(form);
  }
...
<% if (inchulReportViewSize > 0) { %>
<form name="sForm" method="post" action="IR061212.etax">
<input type="hidden" name="cmd" value="inchulReportDetail">
        ...
        <tr> 
          <td colspan="7" height="21"> 
            ...
            <table width="690" border="0" cellspacing="0" cellpadding="6" class="basic" align="center">
              ...
              <tr> 
                <td width="484">제목 : <%=request.getParameter("fis_year")%>년 일반회계 예탁자금 인출</td>
                <td width="225"> 
                  <div align="right"></div>
                </td>
              </tr>
              ...
              <tr> 
                <td colspan="2" height="50"> 
                  <div align="left"><span style="width:43"></span> <%=request.getParameter("fis_year")%>년 일반회계 운영자금 중 예탁자금을 다음과 같이 인출 하고자 하오니 처리하여 주시기 바랍니다.</div>
                </td>
              </tr>
              <tr> 
                <td colspan="2"> 
                  <div align="left"> 
                    <table width="500" border="0" cellspacing="1" cellpadding="3" class="num">
                      <tr> 
                        <td><span style="width:43"></span> 1. 인출금액 : 금 <%=TextHandler.formatNumber(totAmt.getString("TOT_AMT"))%>원(금<%=totAmt.getString("HANGUL_AMT")%>) </td>
                      </tr>
                      <tr> 
                        <td><span style="width:43"></span> 2. 인출내역</td>
                      </tr>
                    </table>
                  </div>
                </td>
              ...
              <tr> 
                ...
                <td width="74" height="34"> 
                  <div align="center">이자(원)</div>
							...
							<% String due_date = "";
							   for (int i=0; i<inchulReportViewSize; i++) { 
								   CommonEntity rowData = (CommonEntity)inchulReportView.get(i);
            ...
            <table width="690" border="0" cellspacing="0" cellpadding="1" class="num" align="center">
              <tr> 
                <td height="60" colspan="3"> 
                  <div align="left"> 
                    <table width="500" border="0" cellspacing="1" cellpadding="3" class="num" align="left">
                      <tr> 
                        <td><span style="width:43"></span> 3. 인출일자 : <%=TextHandler.formatDate(request.getParameter("reg_date"), "yyyyMMddd", "yyyy. MM. dd")%> </td>
                      </tr>
                      <tr> 
                        <td><span style="width:43"></span> 4. 이자수입 : 일반회계 이자수입으로 처리. 끝. </td>
                      </tr>
                    </table>
                </td>
              </tr>
...
<div class="noprint">
<div align="right">
      <img src="../img/btn_inlist.gif" alt="인출내역" onClick="goList()" align="absmiddle" style="cursor:hand">
