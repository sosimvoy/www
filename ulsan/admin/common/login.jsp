...
function login() {
  ...
  document.hFrame.location = "hidden_login.etax?userid="+form.userid.value+"&userpw="+form.userpw.value;
}
...
<form name="sForm" method="post" action="login.etax?cmd=managerLogin">
