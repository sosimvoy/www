...
public class IR050210 {
    ...
    public static List<CommonEntity> getAllotList(Connection conn, CommonEntity paramInfo) throws SQLException {
        ...
        sb.append("    AND A.M100_ALLOTGUBUN = '1'                        \n");
	...
	/* 자금배정 배정처리 */
    public static int updateAllotStat(Connection conn, String seq, CommonEntity paramInfo) throws SQLException {
        StringBuffer sb = new StringBuffer();
    ...
    /* 자금배정 배정취소 */
    public static int allotDelete(Connection conn, String seq, CommonEntity paramInfo) throws SQLException {
        StringBuffer sb = new StringBuffer();
	...
	/* 자금배정 책임자승인 전송 */
    public static int updateAllotPms(Connection conn, CommonEntity paramInfo, String seq) throws SQLException {
        StringBuffer sb = new StringBuffer();
