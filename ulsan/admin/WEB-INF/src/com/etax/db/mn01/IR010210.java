...
public class IR010210 {
	...
	/*부서명 조회*/
	public static List<CommonEntity> getAccDeptList(Connection conn, CommonEntity paramInfo) throws SQLException {
    StringBuffer sb = new StringBuffer();
  ...
  /* 수납기관 조회 */ 
	...
	/* 수기분등록 */
    public static int writeInsert(Connection conn, CommonEntity paramInfo) throws SQLException {
		StringBuffer sb = new StringBuffer();
		...
		sb.append("	,M010_ACCTYPE, M010_LOGNO                      \n"); 		//회계구분, 로그
