...
/* 보고서 조회 */
    ...
    sb.append("             AND M220_DATE BETWEEN ? AND ? ) E       															                    														 \n");
	  sb.append(" WHERE  A.M390_YEAR       =  B.M370_YEAR(+)                                                                                         \n");								  
		...
		sb.append("   AND  SUBSTR(A.M390_SEMOKCODE,1,1) = '2'						                                                                               \n");
		sb.append("   AND  C.M220_PARTCODE(+) NOT IN ('00110','00140','00170','00200','00710','02130','02140','02190','02220','02240')                 \n");
