...
* 프로그램명     : IR030510InsertCMD.java
* 프로그램작성자 : (주)미르이즈
* 프로그램작성일 : 2010-07-28
* 프로그램내용   : 세외수입 > 과오납 결과통보
****************************************************************/
...
public class IR040510InsertCMD extends BaseCommand {
	private static Logger logger = Logger.getLogger(IR040510InsertCMD.class);	// log4j 설정
    ...
    if (IR040510.upateRstState(conn, paramInfo) <1) { //결과통보 상태로
    ...
    request.setAttribute("page.mn04.SucMsg",    "결과통보 완료되었습니다.");
	}
}