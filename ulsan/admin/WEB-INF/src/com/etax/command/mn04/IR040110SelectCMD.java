...
public class IR040110SelectCMD extends BaseCommand {

    private static Logger logger = Logger.getLogger(IR040110SelectCMD.class); // log4j 설정
    ...
    public void execute(HttpServletRequest request, HttpServletResponse response, Connection conn) throws SQLException{ 
		...
		if ("Y".equals(request.getParameter("flag")) ) {  //조회버튼을 통해서 command 명령을 내린건지 판단
			...
			request.setAttribute("page.mn04.ipgumTransList", dataList);
			request.setAttribute("page.mn04.ErrMsg",  errMsg);
			request.setAttribute("page.mn04.rstData",  rstData);
		}
    }
}