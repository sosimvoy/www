...
public class IR050210DeleteCMD extends BaseCommand {

  private static Logger logger = Logger.getLogger(IR050210DeleteCMD.class); // log4j 설정
  ...
  public void execute(HttpServletRequest request, HttpServletResponse response, Connection conn) throws SQLException{ 
    ...
    paramInfo.setValue("allot_date",         request.getParameter("allot_date"));
		...
		paramInfo.setValue("log_no",             request.getParameter("log_no"));
