...
import com.etax.db.mn07.IR070116;
import com.etax.db.common.ReportDAO;
import com.etax.entity.CommonEntity;

public class IR070116SelectCMD extends BaseCommand {
	private static Logger logger = Logger.getLogger(IR070116SelectCMD.class);	// log4j 설정
	public void execute(HttpServletRequest request,	HttpServletResponse response, Connection conn) throws SQLException {
		...
		request.setAttribute("page.mn07.endState", endState);
                ...
                List<CommonEntity> reportList = new ArrayList<CommonEntity>();
        if ("2010".equals(acc_year)) {
            // 보고서
  		    reportList = IR070116.getReportList(conn, paramInfo);
        } else {
            reportList = IR070116.getReportList1(conn, paramInfo);
		}
