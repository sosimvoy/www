...
import com.etax.db.mn07.IR070119;
import com.etax.db.common.ReportDAO;
import com.etax.entity.CommonEntity;

public class IR070119SelectCMD extends BaseCommand {
	private static Logger logger = Logger.getLogger(IR070119SelectCMD.class);	// log4j 설정
	public void execute(HttpServletRequest request,	HttpServletResponse response, Connection conn) throws SQLException {
		...
		// 보고서 (본청만)
  		CommonEntity reportData = IR070119.getReportData(conn, paramInfo);
		request.setAttribute("page.mn07.reportData", reportData);
        
        // 보고서 (구군청 - 본청제외)
  		List<CommonEntity> reportList = IR070119.getReportList(conn, paramInfo);
		request.setAttribute("page.mn07.reportList", reportList);
        
        // 보고서 (합계 - 본청포함)
  		CommonEntity totalData = IR070119.getTotalData(conn, paramInfo);
