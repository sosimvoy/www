...
* 프로그램명     : IR070134SelectCMD.java
* 프로그램작성자 : (주)미르이즈
* 프로그램작성일 : 2010-09-10
* 프로그램내용   : 일계보고서 > 보고서 조회 > 세입분기표(본청광역시세)
**********************************************************************/
...
import com.etax.db.mn07.IR070134;
import com.etax.db.common.ReportDAO;   
import com.etax.entity.CommonEntity;

public class IR070134SelectCMD extends BaseCommand {
	
  private static Logger logger = Logger.getLogger(IR070134SelectCMD.class);	// log4j 설정
    ...
    /* 마감여부	*/
		...
		/* 보고서 */
  		List<CommonEntity> reportList = IR070134.getReportList(conn, paramInfo);
