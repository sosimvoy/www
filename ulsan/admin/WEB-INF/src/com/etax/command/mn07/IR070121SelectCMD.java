...
import com.etax.db.mn07.IR070121;
import com.etax.db.common.ReportDAO;
import com.etax.entity.CommonEntity;

public class IR070121SelectCMD extends BaseCommand {
	private static Logger logger = Logger.getLogger(IR070121SelectCMD.class);	// log4j 설정
	public void execute(HttpServletRequest request,	HttpServletResponse response, Connection conn) throws SQLException {
  	...
  	CommonEntity endState = ReportDAO.getEndState(conn, paramInfo);
		...
		List<CommonEntity> reportList = IR070121.getReportList(conn, paramInfo);
		request.setAttribute("page.mn07.reportList", reportList);
 	
		CommonEntity totReportList = IR070121.getTotReportList(conn, paramInfo);
