...
import com.etax.db.mn07.IR070127;
import com.etax.db.common.ReportDAO;   
import com.etax.entity.CommonEntity;

public class IR070127SelectCMD extends BaseCommand {
	private static Logger logger = Logger.getLogger(IR070127SelectCMD.class);	// log4j 설정
    ...
    /* 마감여부	*/
		...
		/* 보고서 */
  		List<CommonEntity> reportList = IR070127.getReportList(conn, paramInfo);
