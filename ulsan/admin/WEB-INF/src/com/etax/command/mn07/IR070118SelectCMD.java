...
import com.etax.db.mn07.IR070118;
import com.etax.db.common.ReportDAO;
import com.etax.entity.CommonEntity;

public class IR070118SelectCMD extends BaseCommand {
	private static Logger logger = Logger.getLogger(IR070118SelectCMD.class);	// log4j 설정
	public void execute(HttpServletRequest request,	HttpServletResponse response, Connection conn) throws SQLException {
		...
		// 보고서
  		CommonEntity reportData = IR070118.getReportData(conn, paramInfo);
