...
import com.etax.db.mn07.IR070113;
import com.etax.db.common.ReportDAO;
import com.etax.entity.CommonEntity;

public class IR070113SelectCMD extends BaseCommand {
	private static Logger logger = Logger.getLogger(IR070113SelectCMD.class);	// log4j 설정
	public void execute(HttpServletRequest request,	HttpServletResponse response, Connection conn) throws SQLException {
		...
		// 보고서
  		List<CommonEntity> reportList = IR070113.getReportList(conn, paramInfo);
		request.setAttribute("page.mn07.reportList", reportList);
	
		/* 총 카운트 조회 */
		CommonEntity rowData = IR070113.getTotalCount(conn, paramInfo);
