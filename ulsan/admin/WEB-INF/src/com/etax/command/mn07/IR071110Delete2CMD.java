...
public class IR071110Delete2CMD extends BaseCommand {
	private static Logger logger = Logger.getLogger(IR071110Delete2CMD.class);	// log4j 설정
    ...
    if ("Y".equals(passChk.getString("EXIST_YN")) ) {
  		/* 수입일계표 취소 */		
	  	IR071110.budgetProcbeforDelete(conn, paramInfo);
		  request.setAttribute("page.mn07.SucMsg", "취소되었습니다.");
    }else {
		  request.setAttribute("page.mn07.SucMsg", "생성된자료가 없습니다.");
    }
