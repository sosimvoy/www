...
import com.etax.db.mn07.IR070111;
import com.etax.db.common.ReportDAO;    // 직인 
import com.etax.entity.CommonEntity;

public class IR070111SelectCMD extends BaseCommand {
	private static Logger logger = Logger.getLogger(IR070111SelectCMD.class);	// log4j 설정
	public void execute(HttpServletRequest request,	HttpServletResponse response, Connection conn) throws SQLException {
		...
		// 보고서
  		List<CommonEntity> reportList = IR070111.getReportList(conn, paramInfo);
