...
import com.etax.db.mn07.IR070114;
import com.etax.db.common.ReportDAO;
import com.etax.entity.CommonEntity;

public class IR070114SelectCMD extends BaseCommand {
	private static Logger logger = Logger.getLogger(IR070114SelectCMD.class);	// log4j 설정
	public void execute(HttpServletRequest request,	HttpServletResponse response, Connection conn) throws SQLException {
		...
		// 보고서
  		List<CommonEntity> reportList = IR070114.getReportList(conn, paramInfo);
		request.setAttribute("page.mn07.reportList", reportList); 

        // 비고데이터
  		CommonEntity reportRemark = IR070114.getReportRemark(conn, paramInfo);
		request.setAttribute("page.mn07.reportRemark", reportRemark);
	}
}                                                           