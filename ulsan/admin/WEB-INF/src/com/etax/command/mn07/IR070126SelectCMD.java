...
* 프로그램명     : IR070126SelectCMD.java
* 프로그램작성자 : (주)미르이즈
* 프로그램작성일 : 2010-09-10
* 프로그램내용   : 일계보고서 > 보고서 조회 > 세입월계표(총괄세외수입)
*************************************************************************/
...
import com.etax.db.mn07.IR070126;
import com.etax.db.common.ReportDAO;   
import com.etax.entity.CommonEntity;

public class IR070126SelectCMD extends BaseCommand {
	private static Logger logger = Logger.getLogger(IR070126SelectCMD.class);	// log4j 설정
    ...
    /* 마감여부	*/
		...
		/* 보고서 */
  		List<CommonEntity> reportList = IR070126.getReportList(conn, paramInfo);
