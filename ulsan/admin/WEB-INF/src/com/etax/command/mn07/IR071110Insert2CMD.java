...
public class IR071110Insert2CMD extends BaseCommand {
	private static Logger logger = Logger.getLogger(IR071110Insert2CMD.class);	// log4j 설정
    ...
    logger.info("paramInfo : " + paramInfo);		
		...
		/* 수입일계표 생성전 자료체크 */		
		CommonEntity passChk = IR071110.budgetProcbeforDatachk(conn, paramInfo);
    
    if ("Y".equals(passChk.getString("EXIST_YN")) ) {
		  request.setAttribute("page.mn07.SucMsg", "생성된자료가 있습니다.취소후 다시하세요.");
    }else {
  		/* 수입일계표 생성 */		
	  	proccnt = IR071110.budgetProc(conn, paramInfo);
		  request.setAttribute("page.mn07.SucMsg", proccnt + "건 생성되었습니다.");
    }
