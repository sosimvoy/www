...
* 프로그램명     : IR070133SelectCMD.java
* 프로그램작성자 : (주)미르이즈
* 프로그램작성일 : 2010-09-10
* 프로그램내용   : 일계보고서 > 보고서 조회 > 세입분기표(총괄세외수입)
**********************************************************************/
...
import com.etax.db.mn07.IR070133;
import com.etax.db.common.ReportDAO;   
import com.etax.entity.CommonEntity;

public class IR070133SelectCMD extends BaseCommand {
	
  private static Logger logger = Logger.getLogger(IR070133SelectCMD.class);	// log4j 설정
    ...
    int acc_date_int = Integer.parseInt(acc_date);        //회계일자를 int형으로 바꾸기 위해.. 변수 선언    , int형으로 바꾼 이유는.. 비교 하려고. String값은 비교안되니까..
    ...
    /* 마감여부	*/
		...
		/* 보고서 */
  		List<CommonEntity> reportList = IR070133.getReportList(conn, paramInfo);
