...
import com.etax.db.mn07.IR070136;
import com.etax.db.common.ReportDAO;   
import com.etax.entity.CommonEntity;

public class IR070136SelectCMD extends BaseCommand {
	private static Logger logger = Logger.getLogger(IR070136SelectCMD.class);	// log4j 설정
    ...
    /* 마감여부	*/
		...
		/* 보고서 */
  		List<CommonEntity> reportList = IR070136.getReportList(conn, paramInfo);
    ...
    /* 분기 */
	   request.setAttribute("page.mn07.quarter", quarter);
		...
		/* 총 카운트 조회 */
		CommonEntity rowData = IR070136.getTotalCount(conn, paramInfo);
