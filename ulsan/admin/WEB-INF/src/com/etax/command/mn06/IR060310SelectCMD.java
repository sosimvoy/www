...
* 프로그램명        : IR060310SelectCMD.java
* 프로그램작성자    :
* 프로그램작성일    :
* 프로그램내용      : 자금운용 > 자금예탁승인조회
***********************************************************************/
...
public class IR060310SelectCMD extends BaseCommand {

  private static Logger logger = Logger.getLogger(IR060310SelectCMD.class); // log4j 설정
