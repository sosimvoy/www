...
public class IR061310SelectCMD extends BaseCommand {

  private static Logger logger = Logger.getLogger(IR061310SelectCMD.class); // log4j 설정
  ...
  public void execute(HttpServletRequest request, HttpServletResponse response, Connection conn) throws SQLException{    
    ...
    List<CommonEntity> inchulSpList = new ArrayList<CommonEntity>();
    /* 회계종류 조회 */
      ...
      inchulSpList = IR061310.getInchulSpList(conn, paramInfo);
		}
