...
<html>
    ...
    <script language="javascript" src="../js/calendar.js"></script>	
      ...
      function init() {
	      ...
	      var form = document.sForm;
		    form.action = "IR020310.etax";
		    form.cmd.value = "batchsugiint";
		    form.target = "_self";
		    eSubmit(form);
	    }
     </script>
  ...
  <form name="sForm" method="post" action="IR020310.etax">
  ...
  <!-- 팝업시 보내는 코드값 -->                                               
    ...
    <table width="993" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td width="15">&nbsp;</td>
        <td width="975" height="40"><img src="../img/title2_4.gif"></td>
      </tr>
      <tr> 
        <td width="15">&nbsp;</td>
