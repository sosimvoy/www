...
<%
	CommonEntity endWorkDate = (CommonEntity)request.getAttribute("page.mn09.endWorkDate");
...
<html>
  ...
  <form name="sForm" method="post" action="IR091110.etax">
      ...
      <tr> 
        ...
        <td width="975"> 
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="list">
            <tr> 
              <th class="fstleft" width="33%">구분</th>
							<th width="33%">마감일기준</th>
							<th width="34%">수정마감일</th>
            </tr>
            <tr>                 
              <td class="fstleft">&nbsp;일반회계</td>
							<% if (endWorkDate != null ) { %> 
