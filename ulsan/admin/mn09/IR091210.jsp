...
<%
  List<CommonEntity>endYearCode =    (List<CommonEntity>)request.getAttribute("page.mn09.endYearCode");
...
<html>
  ...
  <form name="sForm" method="post" action="IR091210.etax">
      ...
      <tr> 
        ...
        <td width="975"> 
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="list">
            <tr> 
              <th class="fstleft" width="50%">구분</th>
							<th width="50%">등록건수</th>
            </tr>
						<%
						...
						%>
            <tr>                 
							<td class="fstleft">&nbsp;<%=data.getString("cd_name")%></td>
