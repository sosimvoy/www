...
<%
	CommonEntity chUserInfo = (CommonEntity)request.getAttribute("page.mn09.chUserInfo");
...
<html>
  ...
  <form name="sForm" method="post" action="IR090410.etax">
      ...
      <tr> 
        ...
        <td width="975"> 
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="list">
            <tr> 
              <th class="fstleft" width="33%">항목</th>
							<th width="33%">현재</th>
							<th width="33%">변경후</th>
            </tr>
						
            <tr>   
						  <td class="fstleft">&nbsp;부서</td>
              <% if (chUserInfo != null ) { %>
              <td>&nbsp;<input type="text" value="<%=chUserInfo.getString("CURRENTPART")%>" name="" size="20" maxlength="20" class="box1" readonly></td>
	            ...
	            <input type="hidden" name="sign_name" value="<%=chUserInfo.getString("M260_CURRENTSIGNTYPE")%>">
						...
						<tr>   
						  <td class="fstleft">&nbsp;업무</td>
						  <% if (chUserInfo != null ) { %>
              <td>&nbsp; <input type="text" value="<%=chUserInfo.getString("CURRENTWORK1")%>" name="" size="20" maxlength="20" class="box1" readonly></td>
							<% } %>
							<td>&nbsp;
						...
						<tr>   
						  <td class="fstleft">&nbsp;결재권</td>
						  <% if (chUserInfo != null ) { %>
              <td>&nbsp;
							<input type="text" value="<%=chUserInfo.getString("CURRENTSIGNTYPE")%>" name="" size="20" maxlength="20" class="box1" readonly></td>
							<% } %>
							<td >&nbsp; 
              ...
              <tr> 
                <td height="50"> 
                  <div align="right"><img src="../img/btn_apply.gif" width="66" border="0" onclick="gosaveData()" style="cursor:hand">
