...
<%
	CommonEntity userInfo = (CommonEntity)request.getAttribute("page.mn09.userInfo");
...
<html>
    ...
    <script language="javascript" src="../js/calendar.js"></script>	
  	<script language="javascript">
  	    ...
  	    typeInitialize();
			...
			function pw(){
				var form = document.sForm;
				if (form.userpw.value.length == form.chUserpw.value.length) {
					if (form.userpw.value == form.chUserpw.value)	{
						alert('현재패스워드와 변경할 패스워드동일합니다.');
					}
				}
			}
			function hangNo(){
				var form = document.sForm;
				if (form.managerBankerNo.value.length == form.chManagerBankerNo.value.length) {
					if (form.managerBankerNo.value == form.chManagerBankerNo.value)	{
						alert('현재책임자행번과 변경할책임자행번이 동일합니다.');
					}
				}
			}
  ...
  <form name="sForm" method="post" action="IR090310.etax">
      ...
      <table width="100" border="0" cellspacing="0" cellpadding="0" background="../img/box_bg.gif">
        ...
        <tr> 
          <td> 
                ...
                <td width="470"> 
                  <table width="460" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr> 
                      ...
                      <td class="left" width="58%"> 
                        <div align="center"> 
                          <input type="password" name="chUserpw" size="20" value="" maxlength="20" class="box1"onkeyup="pw()">
                        </div>
                      </td>
                    </tr>
										<tr>
                    ...
                    <tr> 
                     ...
                     <td height="10"></td>
                      ...
                      <td width="58%"> 
                        <div align="center"> 
                           <input type="text" name="chManagerBankerNo" size="20" value="" maxlength="20" class="box1" onkeyup="hangNo()">
                        </div>
                      </td>
                    </tr>
										<tr>
                     ...
                     <td height="10"></td>
										...
										<tr> 
                      <th class="fstleft" width="20%" align="right"><font color="#000000" size="2">변경할 책임자번호</font></th>
                      <td width="58%"> 
                        <div align="center"> 
                     ...
                     <td height="10"></td>
										...
										<tr> 
                      <th class="fstleft" width="20%" align="right"><font color="#000000" size="2">변경할 단말번호</font></th>
                      <td width="58%"> 
                        <div align="center"> 
                           <input type="text" name="chTerminalno" size="20" value="" maxlength="20" class="box1">
                        </div>
                      </td>
                    </tr>
                  </table>
            ...
            <table width="270" border="0" cellspacing="1" cellpadding="1" align="center">
              <tr> 
                <td height="50"> 
