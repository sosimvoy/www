...
<%
	List<CommonEntity>userCodeList      = (List<CommonEntity>)request.getAttribute("page.mn09.userCodeList");	
  List<CommonEntity> deptList         = (List<CommonEntity>)request.getAttribute("page.mn09.deptList");
	...
	List<CommonEntity> semokList        = (List<CommonEntity>)request.getAttribute("page.mn09.semokList");
  List<CommonEntity> userAccDeptList1  = (List<CommonEntity>)request.getAttribute("page.mn09.userAccDeptList1");		
      ...
      function goSearch() {
		  ...
		  function goCancel(){
			...
			function changeType(type) {
				document.location = "IR090910.etax?cmd=userCodeList&accGubun="+type+"&year="+document.sForm.year.value;
			}
			function changeDept(dept) {
				var form = document.sForm;
				document.location = "IR090910.etax?cmd=userCodeList&part_code="+dept+"&accGubun="+form.accGubun.value+"&year="+form.year.value;
			}
			function changeNmae(name) {
				var form = document.sForm;
				document.location = "IR090910.etax?cmd=userCodeList&acc_code="+name+"&accGubun="+form.accGubun.value+"&part_code="+form.part_code.value+"&year="+form.year.value;
			}

      function chWorkGubun(work_gubun) {
				var form = document.sForm;
				document.location = "IR090910.etax?cmd=userCodeList&acc_code="+form.acc_code.value+"&accGubun="+form.accGubun.value+"&part_code="+form.part_code.value+"&workGubun="+work_gubun+"&year="+form.year.value;
			}
         	
		  function changeType1(type) {
				document.location = "IR090910.etax?cmd=userCodeList&accGubun1="+type+"&year1="+document.sForm.year1.value;
			}

			function changeDept1(dept) {
				var form = document.sForm;
				document.location = "IR090910.etax?cmd=userCodeList&partCode="+dept+"&accGubun1="+form.accGubun1.value+"&year1="+form.year1.value;
			}
    </script>
  </head>
  <body topmargin="0" leftmargin="0" oncontextmenu="return false">
		<form name="sForm" method="post" action="IR090910.etax">
									...
									<tr>
										...
										<span class="point">회계연도</span>
										  ...
										  <span style="width:30px"></span>
											...
											<select name="part_code" iValue="<%=request.getParameter("part_code")%>" style="width:19%">
								        ...
								        <option value="<%=accCdInfo.getString("M360_ACCCODE")%>"><%=accCdInfo.getString("M360_ACCNAME")%></option>
									      <% } %>
											...
											<select name="workGubun" iValue="<%=request.getParameter("workGubun")%>" style="width:16%" onchange="chWorkGubun(this.value)">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="list">
            ...
            <tr>                 
              <td class="fstleft"><input type="checkbox" name="userChk" value="<%=i%>"></td>
						  ...
						  <td>&nbsp;<%=data.getString("M390_ACCGUBUN_NAME")%></td>
							<td>&nbsp;<%=data.getString("M360_ACCNAME")%></td>
							<td>&nbsp;<%=data.getString("M390_WORKGUBUN_NAME")%></td>
