...
<form name="sForm" method="post" action="IR091012.etax">
              ...
              <tr>
                <td>
                  ...
                  휴일일자&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									...
									<img src="../img/board_icon1.gif" width="8" height="8" align="absmiddle"> 
									휴일명&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
									<input type="text" name="holName" class="box3" size="8" value="" required desc="휴일명">
									<br><br>
							...
							<tr>
								<td width="360"> 
								<div align="center"><img src="../img/btn_order.gif" alt="등록" width="55" height="21" border="0" onClick="gosaveData()" style="cursor:hand">
								</div>
							</td>
              </tr>
            </table>
