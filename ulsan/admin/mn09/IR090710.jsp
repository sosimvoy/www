...
<%
	List<CommonEntity>accCodeList =    (List<CommonEntity>)request.getAttribute("page.mn09.accCodeList");
...
<html>
  ...
  <body topmargin="0" leftmargin="0" oncontextmenu="return false">
		<form name="sForm" method="post" action="IR090710.etax">
